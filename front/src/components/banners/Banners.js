    ...
    <BannerCardWrap>
      <div
        ...
        style={{
          ...
          background: `linear-gradient( rgba(94, 103, 233, 0.9), rgba(0, 0, 0, 0.2)), url("${require('../../static/img/banner/card-banner-2.png')}")`,
        }}
      >
        <h2>Клининг</h2>
        <p>Сделаем любые виды клининга по Вашему желанию. Предлагаем на выбор популярные пакеты уборки.</p>
        <Button size="small" type="white">
          Выбрать услугу
        </Button>
      </div>
  ...
  return (
    <BannerCardWrap>
      <div
        className="banner-card-inner theme-2"
        style={{
          backgroundImage: `url("${require('../../static/img/banner/card-banner-3.png')}")`,
          background: `linear-gradient( rgba(94, 103, 233, 0.9), rgba(0, 0, 0, 0.2)), url("${require('../../static/img/banner/card-banner-3.png')}")`,
        }}
      >
        <h2>Ремонтные работы</h2>
        <p>От вручивания лампочки до черновой отделки.</p>
        <Button size="small" type="white">
          Выбрать услугу
        </Button>
      </div>
  ...
  return (
    <BannerCardWrap>
      <div
        ...
        style={{
          backgroundImage: `url("${require('../../static/img/banner/card-banner-3.png')}")`,
          background: `linear-gradient( rgba(94, 103, 233, 0.9), rgba(0, 0, 0, 0.2)), url("${require('../../static/img/banner/card-banner-4.png')}")`,
        }}
      >
        <h2>Перевозки</h2>
        <p>Перевезем ваши вещи в новый офис и утилизируем хлам.</p>
        <Button size="small" type="white">
          Выбрать услугу
        </Button>
      </div>
